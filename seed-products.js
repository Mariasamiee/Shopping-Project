// seed-products.js
// اجرا: node seed-products.js
// 36 محصول (6 کتگوری × 6 محصول) بر اساس محصولات واقعی سایت آکو اسپرت
...
const categories = [
  {
    ...
    items: [
      ...
      { name: "کفش کوهنوردی مردانه مدل RUNNER", brand: "Kingtex", price: 3980000, hasSize: true, specs: [
        { label: "نام برند", value: "Kingtex" },
        { label: "کاربرد", value: "کوهنوردی حرفه‌ای" },
        { label: "جنس رویی", value: "چرم مصنوعی مقاوم" },
        { label: "نوع کفش", value: "بندی بلند" },
        { label: "جنس زیره", value: "Vibram" },
        { label: "وزن", value: "710 گرم" },
        { label: "خاصیت ضدآب", value: "دارد" },
      ]},
      ...
      { name: "کفش پیاده‌روی زنانه اسپرت", brand: "SpeedFly", price: 1750000, hasSize: true, specs: [
        { label: "نام برند", value: "SpeedFly" },
        { label: "کاربرد", value: "پیاده‌روی روزانه" },
        { label: "جنس رویی", value: "مش سبک" },
        { label: "نوع کفش", value: "کشی" },
        { label: "جنس زیره", value: "لاستیک TPR" },
        { label: "وزن", value: "260 گرم" },
        { label: "خاصیت ضدآب", value: "ندارد" },
      ]},
  ...
  },
  {
    ...
    items: [
      { name: "کوله پشتی کوهنوردی 45 لیتری Mountain", brand: "Mountain", price: 3200000, hasSize: false, specs: [
        { label: "نام برند", value: "Mountain" },
        { label: "کاربرد", value: "کوهنوردی و کمپینگ" },
        { label: "جنس", value: "نایلون 600D" },
        { label: "ظرفیت", value: "45 لیتر" },
        { label: "وزن", value: "1.2 کیلوگرم" },
        { label: "خاصیت ضدآب", value: "دارد (کاور جدا)" },
      ]},
      ...
      { name: "کیسه خواب کوهنوردی 1.8 متری", brand: "WarmNest", price: 980000, hasSize: false, specs: [
        { label: "نام برند", value: "WarmNest" },
        { label: "کاربرد", value: "کمپینگ و کوهنوردی" },
        { label: "جنس", value: "پارچه پلی‌استر با لایه پر مصنوعی" },
        { label: "طول", value: "1.8 متر" },
        { label: "وزن", value: "1.1 کیلوگرم" },
        { label: "خاصیت ضدآب", value: "مقاوم به رطوبت" },
      ]},
      { name: "عصای کوهنوردی جفتی تاشو", brand: "TrekLite", price: 890000, hasSize: false, specs: [
        { label: "نام برند", value: "TrekLite" },
        { label: "کاربرد", value: "کوهنوردی و ترکینگ" },
        { label: "جنس", value: "آلومینیوم سبک" },
        { label: "قابلیت", value: "تنظیم ارتفاع و تاشو" },
        { label: "وزن", value: "480 گرم (جفت)" },
      ]},
      { name: "ظرف غذا و تغذیه مخصوص کوهنوردی و سفر", brand: "TrekLite", price: 385000, hasSize: false, specs: [
        { label: "نام برند", value: "TrekLite" },
        { label: "کاربرد", value: "نگهداری و حمل غذا در سفر" },
        { label: "جنس", value: "استیل ضدزنگ" },
        { label: "ظرفیت", value: "1.2 لیتر" },
        { label: "وزن", value: "420 گرم" },
      ]},
      { name: "کلاه محافظ دوچرخه‌سواری حرفه‌ای Limar", brand: "Limar", price: 1450000, hasSize: false, specs: [
        { label: "نام برند", value: "Limar" },
        { label: "کاربرد", value: "دوچرخه‌سواری حرفه‌ای" },
        { label: "جنس", value: "پلی‌کربنات با تهویه" },
        { label: "وزن", value: "260 گرم" },
  ...
  },
  {
    ...
    items: [
      { name: "ست ورزشی مردانه باشگاهی نایک", brand: "Nike", price: 1430000, hasSize: true, specs: [
        { label: "نام برند", value: "Nike" },
        { label: "کاربرد", value: "تمرین و باشگاه" },
        { label: "جنس", value: "پلی‌استر کشی" },
        { label: "شامل", value: "تیشرت و شلوارک" },
      ]},
      { name: "کاپشن کوهنوردی ضدآب مردانه", brand: "Mountain", price: 2650000, hasSize: true, specs: [
        { label: "نام برند", value: "Mountain" },
        { label: "کاربرد", value: "کوهنوردی و کوهستان" },
        { label: "جنس", value: "پارچه ضدآب و بادگیر" },
        { label: "قابلیت", value: "کلاه‌دار و جیب چندگانه" },
      ]},
      { name: "بارانی سفری قابل تاشو", brand: "TrekLite", price: 420000, hasSize: true, specs: [
        { label: "نام برند", value: "TrekLite" },
        { label: "کاربرد", value: "سفر و کمپینگ" },
        { label: "جنس", value: "پلی‌اتیلن ضدآب" },
        { label: "قابلیت", value: "تاشو و سبک" },
      ]},
      { name: "شلوار کوهنوردی مردانه ضدآب", brand: "Mountain", price: 1590000, hasSize: true, specs: [
        { label: "نام برند", value: "Mountain" },
        { label: "کاربرد", value: "کوهنوردی" },
        { label: "جنس", value: "نایلون ضدآب و ضدخش" },
        { label: "قابلیت", value: "زیپ تهویه" },
      ]},
      { name: "تیشرت ورزشی زنانه تنفس‌پذیر", brand: "SpeedFly", price: 350000, hasSize: true, specs: [
        { label: "نام برند", value: "SpeedFly" },
        { label: "کاربرد", value: "دویدن و تمرین" },
        { label: "جنس", value: "پلی‌استر مش تهویه‌دار" },
      ]},
      { name: "شورت بدنسازی مردانه", brand: "Novoro", price: 290000, hasSize: true, specs: [
        { label: "نام برند", value: "Novoro" },
        { label: "کاربرد", value: "بدنسازی و تمرین" },
        { label: "جنس", value: "الاستان کشی" },
      ]},
    ],
  },
  {
    ...
    items: [
      { name: "دستکش بوکس مارک Reves", brand: "Reves", price: 970000, hasSize: true, specs: [
        { label: "نام برند", value: "Reves" },
        { label: "کاربرد", value: "بوکس و کیک بوکسینگ" },
        { label: "جنس", value: "چرم مصنوعی" },
        { label: "وزن", value: "12 اونس" },
      ]},
      { name: "کیسه بوکس سرعتی گلاوی مدل Venum", brand: "Venum", price: 540000, hasSize: false, specs: [
        { label: "نام برند", value: "Venum" },
        { label: "کاربرد", value: "تمرین سرعت و رفلکس" },
        { label: "جنس", value: "چرم مصنوعی مقاوم" },
      ]},
      { name: "طناب ورزشی 1.5 متری مدل 023", brand: "Novoro", price: 98000, hasSize: false, specs: [
        { label: "نام برند", value: "Novoro" },
        { label: "کاربرد", value: "تمرین کاردیو" },
        { label: "جنس", value: "دسته پلاستیکی، سیم فولادی" },
        { label: "طول", value: "1.5 متر (قابل تنظیم)" },
      ]},
      { name: "دستکش بدنسازی محافظ بانوانه", brand: "Novoro", price: 345000, hasSize: true, specs: [
        { label: "نام برند", value: "Novoro" },
        { label: "کاربرد", value: "بدنسازی و وزنه" },
        { label: "جنس", value: "چرم مصنوعی با پد محافظ" },
      ]},
      { name: "دمبل ورزشی لاستیکی جفتی", brand: "Mountain", price: 780000, hasSize: false, specs: [
        { label: "نام برند", value: "Mountain" },
        { label: "کاربرد", value: "بدنسازی خانگی" },
        { label: "جنس", value: "روکش لاستیکی، هسته چدن" },
        { label: "وزن", value: "هر عدد 5 کیلوگرم" },
      ]},
      { name: "شیکر بدنسازی مدل pro0097", brand: "Novoro", price: 350000, hasSize: false, specs: [
        { label: "نام برند", value: "Novoro" },
        { label: "کاربرد", value: "مکمل و پروتئین" },
        { label: "جنس", value: "پلاستیک بدون BPA" },
        { label: "ظرفیت", value: "700 میلی‌لیتر" },
      ]},
    ],
  },
  {
    ...
    items: [
      { name: "ساک ورزشی مدل 90 نایک", brand: "Nike", price: 700000, hasSize: false, specs: [
        { label: "نام برند", value: "Nike" },
        { label: "کاربرد", value: "باشگاه و سفر کوتاه" },
        { label: "جنس", value: "پلی‌استر مقاوم" },
        { label: "ظرفیت", value: "30 لیتر" },
      ]},
      { name: "ساک ورزشی مدل 37xlz9 جردن", brand: "Jordan", price: 640000, hasSize: false, specs: [
        { label: "نام برند", value: "Jordan" },
        { label: "کاربرد", value: "باشگاه و سفر" },
        { label: "جنس", value: "نایلون ضدسایش" },
        { label: "ظرفیت", value: "28 لیتر" },
      ]},
      { name: "کوله پشتی روزمره اسپرت", brand: "SpeedFly", price: 890000, hasSize: false, specs: [
        { label: "نام برند", value: "SpeedFly" },
        { label: "کاربرد", value: "استفاده روزانه و مدرسه" },
        { label: "جنس", value: "پلی‌استر ضدآب" },
        { label: "ظرفیت", value: "22 لیتر" },
      ]},
      { name: "کیف لوازم آرایش ورزشی", brand: "Novoro", price: 210000, hasSize: false, specs: [
        { label: "نام برند", value: "Novoro" },
        { label: "کاربرد", value: "نگهداری لوازم شخصی" },
        { label: "جنس", value: "پارچه ضدآب" },
      ]},
      { name: "ساک باشگاهی ضدآب", brand: "Mountain", price: 560000, hasSize: false, specs: [
        { label: "نام برند", value: "Mountain" },
        { label: "کاربرد", value: "باشگاه و استخر" },
        { label: "جنس", value: "پلی‌استر پوشش‌دار ضدآب" },
        { label: "ظرفیت", value: "25 لیتر" },
      ]},
      { name: "کیف کمری دویدن", brand: "SpeedFly", price: 265000, hasSize: false, specs: [
        { label: "نام برند", value: "SpeedFly" },
        { label: "کاربرد", value: "دویدن و دوچرخه‌سواری" },
        { label: "جنس", value: "نایلون سبک" },
      ]},
    ],
  },
  {
    ...
    items: [
      { name: "عینک شنا حرفه‌ای مدل zx9", brand: "Novoro", price: 1970000, hasSize: false, specs: [
        { label: "نام برند", value: "Novoro" },
        { label: "کاربرد", value: "شنای حرفه‌ای" },
        { label: "جنس", value: "سیلیکون و پلی‌کربنات ضدبخار" },
      ]},
      { name: "دابر مسافرتی تاشو", brand: "TrekLite", price: 320000, hasSize: false, specs: [
        { label: "نام برند", value: "TrekLite" },
        { label: "کاربرد", value: "حمل آب در سفر" },
        { label: "جنس", value: "پلی‌اتیلن بدون BPA" },
        { label: "ظرفیت", value: "2 لیتر" },
      ]},
      { name: "ترازوی دیجیتال منزل", brand: "Mountain", price: 480000, hasSize: false, specs: [
        { label: "نام برند", value: "Mountain" },
        { label: "کاربرد", value: "اندازه‌گیری وزن بدن" },
        { label: "جنس", value: "شیشه سکوریت" },
        { label: "دقت", value: "100 گرم" },
      ]},
      { name: "اسکیت چرخ چهارتایی", brand: "SpeedFly", price: 2150000, hasSize: true, specs: [
        { label: "نام برند", value: "SpeedFly" },
        { label: "کاربرد", value: "اسکیت‌سواری تفریحی" },
        { label: "جنس", value: "پلی‌یورتان و آلومینیوم" },
      ]},
      { name: "بطری آب ورزشی 750 میلی‌لیتری", brand: "Novoro", price: 185000, hasSize: false, specs: [
        { label: "نام برند", value: "Novoro" },
        { label: "کاربرد", value: "ورزش و باشگاه" },
        { label: "جنس", value: "پلاستیک بدون BPA" },
        { label: "ظرفیت", value: "750 میلی‌لیتر" },
      ]},
      { name: "کلاه شنا سیلیکونی", brand: "Novoro", price: 145000, hasSize: false, specs: [
        { label: "نام برند", value: "Novoro" },
        { label: "کاربرد", value: "شنا" },
...
async function seed() {
  ...
  console.log(`در حال ارسال ${products.length} محصول به ${BASE_URL} ...`);
  ...
  console.log(`تمام شد. ${successCount} از ${products.length} محصول با موفقیت اضافه شد.`);
}
